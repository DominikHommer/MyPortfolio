...
import { FaEnvelope, FaMapMarkerAlt, FaArrowRight, FaExternalLinkAlt } from 'react-icons/fa';
          ...
          <div className="hero-grid">
            ...
            <div className="hero-left">
              ...
              <p className="hero-description">
                Completed B.Sc. in Artificial Intelligence &amp; Data Science at OTH Regensburg (March 2026). Thesis: geometry-aware loss for ViT-based table structure recognition. Incoming M.Sc. student at Uppsala University (Machine Learning &amp; Statistics, Sept 2026). Founder of Castlo Labs — building Patronus, an AI security platform.
              </p>
              ...
              <div className="hero-timeline-card">
                ...
                <div className="hero-timeline-items">
                  ...
                  <div className="hero-timeline-item">
                    <div className="hero-tl-dot"></div>
                    <div className="hero-tl-content">
                      <div className="hero-tl-date">2025 — ongoing</div>
                      <div className="hero-tl-title">ViaLang-Seg</div>
                  ...
                  <div className="hero-timeline-item">
                    ...
                    <div className="hero-tl-content">
                      ...
                      <div className="hero-tl-sub">OTH Regensburg · Geometry Loss</div>
                  ...
                  <div className="hero-timeline-item">
                    <div className="hero-tl-dot dot-green"></div>
                    <div className="hero-tl-content">
                      <div className="hero-tl-date">2025 — present</div>
                      <div className="hero-tl-title">Castlo Labs — Co-Founder</div>
        ...
        <div className="container">
          <div className="about-grid">
            ...
            <div>
              ...
              <p className="about-text">
                Industry experience at Audi, Siemens, and AVL. Founder of Castlo Labs — building Patronus, an AI security platform for LLM monitoring, automated red-teaming, and safety guardrails.
              </p>
              <div className="tags-row">
                ...
                <span className="tag tag-orange">Startup Founder</span>
              </div>
            </div>
            ...
            <div className="about-right">
              ...
              <ul className="about-info-list">
                <li>
                  <FaMapMarkerAlt />
                  <span>Regensburg (from Sept 2026: Uppsala)</span>
                </li>
                <li>
                  <FaEnvelope />
                  <a href="mailto:dominik.hommer@web.de">dominik.hommer@web.de</a>
                </li>
                <li>
                  <SiGithub />
                  <a href="https://github.com/DominikHommer" target="_blank" rel="noopener noreferrer">github.com/DominikHommer</a>
                </li>
                <li>
                  <SiLinkedin />
                  <a href="https://www.linkedin.com/in/dominikhommer" target="_blank" rel="noopener noreferrer">linkedin.com/in/dominikhommer</a>
                </li>
              </ul>
            </div>
        ...
        <div className="container">
          ...
          <div className="projects-grid">
            ...
            <div className="project-card-new">
              <div className="project-card-label">Security · AI Platform</div>
              <h3>Patronus</h3>
              <p>
                Enterprise AI-security platform for LLM monitoring, automated red-teaming, and safety guardrails. Building real-time evaluation and compliance tooling for production AI systems.
              </p>
              <div className="tags-row">
                <span className="tag tag-blue">Python</span>
                <span className="tag tag-purple">LLMs</span>
                <span className="tag">FastAPI</span>
                <span className="tag tag-orange">AI Security</span>
              </div>
            ...
            <div className="project-card-new">
              ...
              <p>
                Deep learning system extracting structured data from handwritten historical tables. Digitizing Swiss ornithological records for conservation. Combines semantic record digitization for conservation research.
              </p>
              <div className="tags-row">
                <span className="tag tag-blue">PyTorch</span>
        ...
        <div className="container">
          ...
          <div className="research-list">
            ...
            <div className="research-item">
              <div className="research-date">2025 — ongoing</div>
              <div className="research-content">
                <h4>ViaLang-Seg: Integrating Vision Transformers &amp; LLMs for Context-Aware Multimodal Image Segmentation</h4>
                <p>
        ...
        <div className="container">
          ...
          <div className="work-list">
            ...
            <div className="work-item">
              <div className="work-date">2025 — present</div>
            ...
            <div className="work-item">
              ...
              <div className="work-content">
                <h4>Working Student – Data Science &amp; AI</h4>
                <div className="work-company">Audi AG · Ingolstadt</div>
                <ul className="work-bullets">
                  <li>Used data mining algorithms to analyze error sequence frequencies.</li>
                  <li>Created unsupervised driving style recognition using autoencoders, time series methods, and clustering.</li>
                  <li>Built LLM-based assistants integrating external documents as a knowledge base.</li>
                </ul>
              </div>
            </div>
